...
wl_compositor_create_region :: #force_inline proc "c" (wl_compositor: ^wl_compositor)
{
  struct wl_proxy *id;
...
wl_shm_pool_create_buffer(struct wl_shm_pool *wl_shm_pool, int32_t offset, int32_t width, int32_t height, int32_t stride, uint32_t format)
{
  ...
  id = wl_proxy_marshal_flags((struct wl_proxy *) wl_shm_pool,
       WL_SHM_POOL_CREATE_BUFFER, &wl_buffer_interface, wl_proxy_get_version((struct wl_proxy *) wl_shm_pool), 0, nil, offset, width, height, stride, format);
...
wl_shm_pool_destroy(struct wl_shm_pool *wl_shm_pool)
{
  wl_proxy_marshal_flags((struct wl_proxy *) wl_shm_pool,
       WL_SHM_POOL_DESTROY, nil, wl_proxy_get_version((struct wl_proxy *) wl_shm_pool), WL_MARSHAL_FLAG_DESTROY);
}
...
{
  wl_proxy_marshal_flags((struct wl_proxy *) wl_shm_pool,
       WL_SHM_POOL_RESIZE, nil, wl_proxy_get_version((struct wl_proxy *) wl_shm_pool), 0, size);
}
...
wl_shm_create_pool(struct wl_shm *wl_shm, int32_t fd, int32_t size)
{
  ...
  id = wl_proxy_marshal_flags((struct wl_proxy *) wl_shm,
       WL_SHM_CREATE_POOL, &wl_shm_pool_interface, wl_proxy_get_version((struct wl_proxy *) wl_shm), 0, nil, fd, size);
...
wl_buffer_destroy(struct wl_buffer *wl_buffer)
{
  wl_proxy_marshal_flags((struct wl_proxy *) wl_buffer,
       WL_BUFFER_DESTROY, nil, wl_proxy_get_version((struct wl_proxy *) wl_buffer), WL_MARSHAL_FLAG_DESTROY);
}
 ...
 * nil for not accepted.
 *
 * For objects of version 2 or older, this request is used by the
 * client to give feedback whether the client can receive the given
 * mime type, or nil if none is accepted; the feedback does not
...
wl_data_offer_accept(struct wl_data_offer *wl_data_offer, uint32_t serial, const char *mime_type)
{
  wl_proxy_marshal_flags((struct wl_proxy *) wl_data_offer,
       WL_DATA_OFFER_ACCEPT, nil, wl_proxy_get_version((struct wl_proxy *) wl_data_offer), 0, serial, mime_type);
}
...
{
  wl_proxy_marshal_flags((struct wl_proxy *) wl_data_offer,
       WL_DATA_OFFER_RECEIVE, nil, wl_proxy_get_version((struct wl_proxy *) wl_data_offer), 0, mime_type, fd);
}
...
{
  wl_proxy_marshal_flags((struct wl_proxy *) wl_data_offer,
       WL_DATA_OFFER_DESTROY, nil, wl_proxy_get_version((struct wl_proxy *) wl_data_offer), WL_MARSHAL_FLAG_DESTROY);
}
 ...
 * this request after a nil mime type has been set in
...
{
  wl_proxy_marshal_flags((struct wl_proxy *) wl_data_offer,
       WL_DATA_OFFER_FINISH, nil, wl_proxy_get_version((struct wl_proxy *) wl_data_offer), 0);
}
...
{
  wl_proxy_marshal_flags((struct wl_proxy *) wl_data_offer,
       WL_DATA_OFFER_SET_ACTIONS, nil, wl_proxy_get_version((struct wl_proxy *) wl_data_offer), 0, dnd_actions, preferred_action);
}
...
struct wl_data_source_listener {
   ...
   * a target does not accept any of the offered types, type is nil.
   *
...
wl_data_source_offer(struct wl_data_source *wl_data_source, const char *mime_type)
{
  wl_proxy_marshal_flags((struct wl_proxy *) wl_data_source,
       WL_DATA_SOURCE_OFFER, nil, wl_proxy_get_version((struct wl_proxy *) wl_data_source), 0, mime_type);
}
...
{
  wl_proxy_marshal_flags((struct wl_proxy *) wl_data_source,
       WL_DATA_SOURCE_DESTROY, nil, wl_proxy_get_version((struct wl_proxy *) wl_data_source), WL_MARSHAL_FLAG_DESTROY);
}
...
{
  wl_proxy_marshal_flags((struct wl_proxy *) wl_data_source,
       WL_DATA_SOURCE_SET_ACTIONS, nil, wl_proxy_get_version((struct wl_proxy *) wl_data_source), 0, dnd_actions);
}
...
struct wl_data_device_listener {
   ...
   * until a new data_offer or nil is received or until the client
 ...
 * for the eventual data transfer. If source is nil, enter, leave
...
wl_data_device_start_drag(struct wl_data_device *wl_data_device, struct wl_data_source *source, struct wl_surface *origin, struct wl_surface *icon, uint32_t serial)
{
  wl_proxy_marshal_flags((struct wl_proxy *) wl_data_device,
       WL_DATA_DEVICE_START_DRAG, nil, wl_proxy_get_version((struct wl_proxy *) wl_data_device), 0, source, origin, icon, serial);
}
 ...
 *
 * To unset the selection, set the source to nil.
 */
static inline void
wl_data_device_set_selection(struct wl_data_device *wl_data_device, struct wl_data_source *source, uint32_t serial)
{
  wl_proxy_marshal_flags((struct wl_proxy *) wl_data_device,
       WL_DATA_DEVICE_SET_SELECTION, nil, wl_proxy_get_version((struct wl_proxy *) wl_data_device), 0, source, serial);
}
...
{
  wl_proxy_marshal_flags((struct wl_proxy *) wl_data_device,
       WL_DATA_DEVICE_RELEASE, nil, wl_proxy_get_version((struct wl_proxy *) wl_data_device), WL_MARSHAL_FLAG_DESTROY);
}
...
wl_data_device_manager_create_data_source(struct wl_data_device_manager *wl_data_device_manager)
{
  ...
  id = wl_proxy_marshal_flags((struct wl_proxy *) wl_data_device_manager,
       WL_DATA_DEVICE_MANAGER_CREATE_DATA_SOURCE, &wl_data_source_interface, wl_proxy_get_version((struct wl_proxy *) wl_data_device_manager), 0, nil);
...
wl_data_device_manager_get_data_device(struct wl_data_device_manager *wl_data_device_manager, struct wl_seat *seat)
{
  ...
  id = wl_proxy_marshal_flags((struct wl_proxy *) wl_data_device_manager,
       WL_DATA_DEVICE_MANAGER_GET_DATA_DEVICE, &wl_data_device_interface, wl_proxy_get_version((struct wl_proxy *) wl_data_device_manager), 0, nil, seat);
...
wl_shell_get_shell_surface(struct wl_shell *wl_shell, struct wl_surface *surface)
{
  ...
  id = wl_proxy_marshal_flags((struct wl_proxy *) wl_shell,
       WL_SHELL_GET_SHELL_SURFACE, &wl_shell_surface_interface, wl_proxy_get_version((struct wl_proxy *) wl_shell), 0, nil, surface);
...
wl_shell_surface_pong(struct wl_shell_surface *wl_shell_surface, uint32_t serial)
{
  wl_proxy_marshal_flags((struct wl_proxy *) wl_shell_surface,
       WL_SHELL_SURFACE_PONG, nil, wl_proxy_get_version((struct wl_proxy *) wl_shell_surface), 0, serial);
}
...
{
  wl_proxy_marshal_flags((struct wl_proxy *) wl_shell_surface,
       WL_SHELL_SURFACE_MOVE, nil, wl_proxy_get_version((struct wl_proxy *) wl_shell_surface), 0, seat, serial);
}
...
{
  wl_proxy_marshal_flags((struct wl_proxy *) wl_shell_surface,
       WL_SHELL_SURFACE_RESIZE, nil, wl_proxy_get_version((struct wl_proxy *) wl_shell_surface), 0, seat, serial, edges);
}
...
{
  wl_proxy_marshal_flags((struct wl_proxy *) wl_shell_surface,
       WL_SHELL_SURFACE_SET_TOPLEVEL, nil, wl_proxy_get_version((struct wl_proxy *) wl_shell_surface), 0);
}
...
{
  wl_proxy_marshal_flags((struct wl_proxy *) wl_shell_surface,
       WL_SHELL_SURFACE_SET_TRANSIENT, nil, wl_proxy_get_version((struct wl_proxy *) wl_shell_surface), 0, parent, x, y, flags);
}
...
{
  wl_proxy_marshal_flags((struct wl_proxy *) wl_shell_surface,
       WL_SHELL_SURFACE_SET_FULLSCREEN, nil, wl_proxy_get_version((struct wl_proxy *) wl_shell_surface), 0, method, framerate, output);
}
...
{
  wl_proxy_marshal_flags((struct wl_proxy *) wl_shell_surface,
       WL_SHELL_SURFACE_SET_POPUP, nil, wl_proxy_get_version((struct wl_proxy *) wl_shell_surface), 0, seat, serial, parent, x, y, flags);
}
...
{
  wl_proxy_marshal_flags((struct wl_proxy *) wl_shell_surface,
       WL_SHELL_SURFACE_SET_MAXIMIZED, nil, wl_proxy_get_version((struct wl_proxy *) wl_shell_surface), 0, output);
}
...
{
  wl_proxy_marshal_flags((struct wl_proxy *) wl_shell_surface,
       WL_SHELL_SURFACE_SET_TITLE, nil, wl_proxy_get_version((struct wl_proxy *) wl_shell_surface), 0, title);
}
...
{
  wl_proxy_marshal_flags((struct wl_proxy *) wl_shell_surface,
       WL_SHELL_SURFACE_SET_CLASS, nil, wl_proxy_get_version((struct wl_proxy *) wl_shell_surface), 0, class_);
}
